...
async function permissions(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-VOD4NK6A.js")).default(client, argv, telemetry);
    case "add":
      return (await import("./add-Y3ACMZQ3.js")).default(client, argv, telemetry);
    case "rm":
      return (await import("./rm-RJOWQHQV.js")).default(client, argv, telemetry);
    case "clear":
      return (await import("./clear-GLMDDDUR.js")).default(client, argv, telemetry);
    default:
