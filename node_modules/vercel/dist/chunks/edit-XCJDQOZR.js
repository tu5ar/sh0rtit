...
import "./chunk-KBEX5MYS.js";
import "./chunk-XLKFJPMT.js";
...
async function edit(client, argv) {
  ...
  if (!originalRoute) {
    ...
    output_manager_default.error(
      `No route found matching "${identifier}". Run ${import_chalk.default.cyan(withGlobalFlags(client, "routes list"))} to see all routes.`
    );
    return 1;
  }
