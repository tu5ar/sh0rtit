...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-7YYHSZIR.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-FEW47KAZ.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-TNCPDKEX.js")).default(client, args, telemetry);
    default:
